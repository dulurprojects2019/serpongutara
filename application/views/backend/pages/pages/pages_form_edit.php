                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="pgs_name" value="<?=$pages['pgs_name']?>"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="imagespages" value="<?=$pages['pgs_images']?>">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <textarea id="editor1" name="pgs_body" class="form-control is-valid" placeholder="Enter Description Pages ..."><?=$pages['pgs_body']?></textarea>
                            <i class="form-group__bar"></i> 
                        </div>
                    </div>
