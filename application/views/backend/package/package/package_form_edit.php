                ...
                <div class="row">
                    ...
                    <?php if($package['inp_images'] != 'noimagesheader.jpg') {?>
                        <div class="card-body">
                            <div class="form-group">
                                <img width="30%" src="<?=base_url()?>assets/backend/img/package/<?=$package['inp_images']?>">
                            </div>
                        </div>
                    <?php } ?>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="inp_id" value="<?=$package['inp_id']?>">
                            <input type="text" name="inp_name" value="<?=$package['inp_name']?>"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="inp_price" value="<?=$package['inp_price']?>"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="imagespackage" value="<?=$package['inp_images']?>">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="inp_tags" value="<?=$package['inp_tags']?>"
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <textarea id="editor1" name="inp_description" class="form-control is-valid" placeholder="Enter Deskripsi Paket ..."><?=$package['inp_description']?></textarea>
                            <i class="form-group__bar"></i> 
                        </div>
                    </div>
