                ...
                <div class="row">
                                ...
                                <select name="usr_level_id" class="form-control" style="background: #000000; opacity: 0.5;">
                                    <?php foreach($levels as $lvl) : ?>
                                        <?php if($lvl['lvl_id'] == $users['usr_level_id']) {?>
                                            <option value="<?=$lvl['lvl_id']?>" selected><?=$lvl['lvl_name']?></option>
                                        <?php }else{ ?>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="usr_fullname" value="<?=$users['usr_fullname']?>"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="Email" name="usr_email" value="<?=$users['usr_email']?>"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="Password" name="usr_passconf" class="form-control is-valid" placeholder="Enter Password ...">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>Phone</label>
                            <input type="number" name="usr_phone" value="<?=$users['usr_phone']?>" class="form-control is-valid" placeholder="Enter Phone Number ...">
                            <i class="form-group__bar"></i>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>Address</label>
                            <textarea name="usr_address" class="form-control is-valid" placeholder="Enter Address ..."><?=$users['usr_address']?></textarea>
                            <i class="form-group__bar"></i> 
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>Photo</label>
                            <input type="hidden" name="photos" value="<?=$users['usr_images']?>">
