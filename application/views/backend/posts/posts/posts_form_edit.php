                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select name="pst_categoriespost_id" class="form-control" style="background: #355956">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="pst_id" value="<?=$posts['pst_id']?>">
                            <input type="text" name="pst_name" value="<?=$posts['pst_name']?>"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>Images</label>
                            <input type="hidden" name="imagesposts" value="<?=$posts['pst_images']?>">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <textarea id="editor1" name="pst_body" class="form-control is-valid" placeholder="Enter Description posts ..."><?=$posts['pst_body']?></textarea>
                            <i class="form-group__bar"></i> 
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6" >
                        <div class="form-group">
                            ...
                            <input type="text" name="pst_tags" value="<?=$posts['pst_tags']?>" class="form-control is-valid" placeholder="Input Your Tags Separated with ',' (ex: culture,sports,business,ets) ...">
