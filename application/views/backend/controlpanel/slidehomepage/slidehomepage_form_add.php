<div class="content__inner">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="<?php echo site_url('slidehomepage/add')?>" method="post" enctype="multipart/form-data">

                <div class="row">

                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>Nama Promo Slide <a style="color: red;">*</a></label>
                            <input type="text" name="lsh_name" class="form-control is-valid">
                            <a style="color: red;"><?=form_error('lsh_name')?></a>
                        </div>
                    </div>
